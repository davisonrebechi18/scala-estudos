...
// Scala fornece uma estrutura de dados, o array, que armazena um coleção de tamanho Fixo de Elementos do mesmo tipo.
...
def main(args: Array[String]) = {
    ...
    // Cria um array
    var arr2 = Array(2.3, 1.7, 4.5, 3.8)
    ...
    // Cria um array
    var arr3 = Array(2.3, 1.7, 4.5, 3.8)

    // Variável com o maior valor (consideramos o elemnto de indice zero para começar)
    var max = arr3(0);
